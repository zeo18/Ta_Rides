...
class _UserRideListState extends State<UserRideList> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        if (widget.ride.enemyFinished == false)
          Card(
                    ...
                    Row(
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              "${widget.ride.enemyFirstname.replaceRange(0, 1, widget.ride.enemyFirstname[0].toUpperCase())} ${widget.ride.enemyLastname.replaceRange(0, 1, widget.ride.enemyLastname[0].toUpperCase())}",
        ...
        else if (widget.ride.userWinner)
          Card(
            color: const Color(0xff282828),
            margin: const EdgeInsets.all(10),
            shape: RoundedRectangleBorder(
                  ...
                  Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            "${widget.ride.userFirstname.replaceRange(0, 1, widget.ride.userFirstname[0].toUpperCase())} ${widget.ride.userLastname.replaceRange(0, 1, widget.ride.userLastname[0].toUpperCase())}",
                            style:
        ...
        else if (widget.ride.enemyWinner)
          Card(
            color: const Color(0xff282828),
            margin: const EdgeInsets.all(10),
            shape: RoundedRectangleBorder(
